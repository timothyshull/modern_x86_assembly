...
{
    sprintf(s, len, "%4d %4d %4d %4d %4d %4d %4d %4d | %4d %4d %4d %4d %4d %4d %4d %4d",
              i8[0], i8[1], i8[2], i8[3],
              i8[4], i8[5], i8[6], i8[7],
...
{
    sprintf(s, len, "%8d %8d %8d %8d | %8d %8d %8d %8d",
...
{
    sprintf(s, len, "%25lld | %25lld", i64[0], i64[1]);
    return s;
}

char *XmmVal::ToString_u8(char *s, size_t len)
{
    sprintf(s, len, "%4u %4u %4u %4u %4u %4u %4u %4u | %4u %4u %4u %4u %4u %4u %4u %4u",
              u8[0], u8[1], u8[2], u8[3],
              u8[4], u8[5], u8[6], u8[7],
...
{
    sprintf(s, len, "%8u %8u %8u %8u | %8u %8u %8u %8u",
...
{
    sprintf(s, len, "%25llu | %25llu", u64[0], u64[1]);
    return s;
}

char *XmmVal::ToString_x8(char *s, size_t len)
{
    sprintf(s, len, "%02X %02X %02X %02X %02X %02X %02X %02X | %02X %02X %02X %02X %02X %02X %02X %02X",
              u8[0], u8[1], u8[2], u8[3],
              u8[4], u8[5], u8[6], u8[7],
              u8[8], u8[9], u8[10], u8[11],
              u8[12], u8[13], u8[14], u8[15]
...
{
    sprintf(s, len, "%04X %04X %04X %04X | %04X %04X %04X %04X",
              u16[0], u16[1], u16[2], u16[3],
              u16[4], u16[5], u16[6], u16[7]
    );
    return s;
...
{
    sprintf(s, len, "%25llX | %25llX", u64[0], u64[1]);
    return s;
}

char *XmmVal::ToString_r32(char *s, size_t len)
{
    sprintf(s, len, "%12.6f %12.6f | %12.6f %12.6f",
